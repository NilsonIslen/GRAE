...
if($NColor==$NumAl){
$sql="insert into clients(NameCli,Barrio,Direccion,maps,TelCli,Frecuencia,Visita,hour,Ruta) values(:NameCli,:Barrio,:Direccion,:maps,:TelCli,:Frecuencia,:Visita,:hour,:Ruta)";
